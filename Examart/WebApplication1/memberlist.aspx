<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="memberlist.aspx.cs" Inherits="WebApplication1.memberlist" %>
...
<body>
    <form id="form1" runat="server">
      ...
      <div style="font-family:'Times New Roman';font-size:100px; font-weight:bolder; text-align:center; background-color:#78b4ff; width:100%;">Student List</div> 
      <div>
      <ul>
        ...
        <asp:Repeater ID="Repeat" runat="server">
            <ItemTemplate>
                <asp:Table ID="Table" CssClass="table" runat="server" Width="800px" HorizontalAlign="Center" BackColor="#CCCCCC">
                    ...
                    <asp:TableRow>
                        <asp:TableCell HorizontalAlign="Left">
                            <asp:Button ID="addbtn" CssClass="addbtn" Text="Add as an Admin" runat="server" CommandArgument='<%#Eval("LogInID") %>' OnClick="addbtn_Click"/></asp:TableCell>
                    </asp:TableRow>
                </asp:Table>
            </ItemTemplate>
        </asp:Repeater>
      ...
      <div id="footer"><hr style="width: 80%"/>
          ...
          <a href="adminlist.aspx" class="extralink" style="color: black">Admin List</a><br />
        </div>
    </form>
</body>
</html>
